...
export default function LoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    const res = await fetch("/api/in/login", {
      method: "POST",
    ...
    // role-based redirect
    if (data.user.role === "admin") router.push("in/dashboard")
    else router.push("in/dashboard/form")
  }
  ...
  const handleRegister = async (e) => {
    ...
    const res = await fetch("/api/in/register", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
